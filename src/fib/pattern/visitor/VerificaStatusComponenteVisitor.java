 ...
 * de verificação de status. cada um dos métodos "visitar" recebe como
 * parâmetro o componente a ser modificado. No nosso exemplo não fazemos
 * modificações nos objetos, mas o padrão consiste em exatamemente modificar
 * o estado do objeto passado de forma que não é necessário codificar a
 * classe do objeto, mas apenas definir a ação em uma nova classe.
 */
